...
//  ESTRUTURAS DE ENTRADA E RETORNO DO MÉTODO INCLUIRCELINTE
    ...
    WSMETHOD IncluirCliente    DESCRIPTION "Inclui dados de cliente na base de dados do Protheus/SA1"
ENDWSSERVICE 
...
Local cA1LOJA       := StrTran(::WsDadosCli:clienteA1LOJA,"?","")
...
Local cA1MUN        := ::WsDadosCli:clienteA1MUNICIP
Local cA1EST        := ::WsDadosCli:clienteA1ESTADO
...
ELSE 
    ...
    ELSE
        ...
        ::WSRetInclusao:cMessage    := "OPERAÇÃO CONCLUÍDA COM SUCESSO! OS SEUS DADOS FORAM ENVIADOS PARA O TOTVS PROTHEUS"        
    ENDIF
