...
//Variáveis da função XmlParser( [ cXml ], [ cReplace ], [ cError ], [ cWarning ] )
...
//// implementar GetArea()
    ...
    //Se não tiver vazio, ele fará a busca
    IF !Empty(M->A1_CEP)
        //Montamos o cabeçalho do SOAP
        ...
        //Utilizaremos o sPostRet para trabalharmos dentro da função XMLParser
